...
export function AdminDashboard() {
    ...
    return(
        <div>
            <h3 className="d-flex justify-content-between"> <span>Admine Dashboard</span> <span>{cookies['admin_id']}</span> <button onClick={handleSignout} className="btn btn-link">Signout</button> </h3>
            <div className="mt-2">
                <div>
